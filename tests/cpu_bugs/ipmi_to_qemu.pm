...
use testapi;
use utils;
use version_utils 'is_sle', 'get_sles_release';
...
sub run {
    ...
    print "sles_running_version: $sles_running_version\n";
    print "sles_running_sp: $sles_running_sp\n";
    ...
    print "sles_running_version: $sles_running_version, sles_running_sp: $sles_running_sp, current_dist: $current_dist\n";
